...
from opencood.data_utils.datasets.intermediate_heter_fusion_dataset_v2xscenes import getIntermediateheter_v2xscenesFusionDataset
...
def build_dataset(dataset_cfg, visualize=False, train=True):
    ...
    assert fusion_name in ['late', 'lateheter', 'intermediate', 'intermediateheter_v2xscenes', 'intermediate2stage', 'intermediateheter', 'early', 'intermediateheterinfer']
    assert dataset_name in ['opv2v', 'v2xsim', 'dairv2x', 'v2xset', 'v2xscenes']
